...
export default function PaginaInicial() {
  return (
    <div className="min-h-screen">
      ...
      {/* Sistemas Section */}
      <section className="py-20 px-4 bg-gradient-to-b from-[#05080F] via-[#0B1725] to-[#05080F]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="font-orbitron text-sm uppercase tracking-[0.2em] text-[#FF2E44]">
                Experiência de Jogo
              </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 bg-[#121622] p-6 clip-cut border border-[#FF2E44]/30 hover-lift reticule relative group">
                <div className="flex items-start gap-5">
                  <div className="text-[#FF2E44] mb-4 group-hover:scale-110 transition-transform duration-300 shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-orbitron text-xl font-bold text-white mb-2">SISTEMA DE TRABALHOS</h3>
                    <p className="font-rajdhani text-[#B3B9C1]">
              ...
              {/* Sistema de Veículos */}
              <div className="bg-[#121622] p-6 clip-cut border border-[#FF2E44]/20 hover-lift reticule relative group">
                <div className="text-[#FF2E44] mb-4 group-hover:scale-110 transition-transform duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="font-orbitron text-xl font-bold text-white mb-2">SISTEMA DE VEÍCULOS</h3>
                <p className="font-rajdhani text-[#B3B9C1]">
              ...
              <div className="bg-[#121622] p-6 clip-cut border border-[#FF2E44]/20 hover-lift reticule relative group">
                ...
                <h3 className="font-orbitron text-xl font-bold text-white mb-2">ANIMAÇÕES EXCLUSIVAS</h3>
                <p className="font-rajdhani text-[#B3B9C1]">
              ...
              <div className="md:col-span-2 bg-[#121622] p-6 clip-cut border border-[#FF2E44]/30 hover-lift reticule relative group">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="font-orbitron text-xl font-bold text-white mb-2">SISTEMA DE IMÓVEIS</h3>
                    <p className="font-rajdhani text-[#B3B9C1]">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-2 bg-[#121622] p-6 clip-cut border border-[#FFCC00]/30 hover-lift reticule relative group">
                <div className="flex items-start gap-5">
                  <div className="text-[#FFCC00] mb-4 group-hover:scale-110 transition-transform duration-300 shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-orbitron text-xl font-bold text-white mb-2">OTIMIZAÇÃO FPS</h3>
                    <p className="font-rajdhani text-[#B3B9C1]">
              ...
              {/* Anti-Cheat */}
              <div className="bg-[#121622] p-6 clip-cut border border-[#FFCC00]/20 hover-lift reticule relative group">
                <div className="text-[#FFCC00] mb-4 group-hover:scale-110 transition-transform duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <h3 className="font-orbitron text-xl font-bold text-white mb-2">ANTI-CHEAT</h3>
                <p className="font-rajdhani text-[#B3B9C1]">
              ...
              <div className="md:col-span-2 bg-[#121622] p-6 clip-cut border border-[#FFCC00]/30 hover-lift reticule relative group">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="font-orbitron text-xl font-bold text-white mb-2">SERVIDORES DEDICADOS</h3>
                    <p className="font-rajdhani text-[#B3B9C1]">
              ...
              <div className="bg-[#121622] p-6 clip-cut border border-[#FFCC00]/20 hover-lift reticule relative group">
                ...
                <h3 className="font-orbitron text-xl font-bold text-white mb-2">MODS EXCLUSIVOS</h3>
                <p className="font-rajdhani text-[#B3B9C1]">
